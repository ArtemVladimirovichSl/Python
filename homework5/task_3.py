...
def check_line(a1, a2, a3, smb):
    if a1['text'] == a2['text'] == a3['text'] == smb:
...
def can_win(a1, a2, a3, smb):
    res = False
    if a1['text'] == a2['text'] == smb and a3['text'] == ' ':
        a3['text'] = 'O'
        res = True
    if a1['text'] == smb and a2['text'] == ' ' and a3['text'] == smb:
        a2['text'] = 'O'
        res = True
    if a1['text'] == ' ' and a2['text'] == a3['text'] == smb:
        a1['text'] = 'O'
        res = True
    return res
...
new_button.grid(row=3, column=0, columnspan=3, sticky='nswe')
root.mainloop()
