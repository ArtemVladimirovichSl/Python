...
print('Результат:', eval(input('Задайте арифметическое выражение: ')))   # ВАРИАНТ 1:   ОПАСНЫЙ
...
expression = input('Задайте арифметическое выражение: ')
print('Результат: ', calc(sort(parse(expression))))
